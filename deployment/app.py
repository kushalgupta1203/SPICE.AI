...
CLASS_CONFIG = {
    "Panel Detected": {
        "ranges": [(0, 2, 0.017), (2, 4, 0.023), (4, 6, 0.038), (6, 8, 0.041), (8, 10, 0.056),
                   ...
                   (80, 82, 0.913), (82, 84, 0.925), (84, 86, 0.937), (86, 88, 0.948), (88, 90, 0.956),
                   (90, 92, 1.013), (92, 94, 1.024), (94, 96, 1.036), (96, 98, 1.047), (98, 100, 1.058), (100, 101, 1.069)]
    },
    "Clean Panel": {
        "ranges": [(0, 2, -0.917), (2, 4, -0.925), (4, 6, -0.936), (6, 8, -0.948), (8, 10, -0.953),
    ...
    "Physical Damage": {
        "ranges": [(0, 2, -1.012), (2, 4, -0.817), (4, 6, -0.823), (6, 8, -0.834), (8, 10, -0.845),
    ...
    "Electrical Damage": {
        "ranges": [(0, 2, -1.023), (2, 4, -0.812), (4, 6, -0.823), (6, 8, -0.831), (8, 10, -0.842),
    ...
    "Snow Covered": {
        "ranges": [(0, 2, -1.034), (2, 4, -0.813), (4, 6, -0.824), (6, 8, -0.836), (8, 10, -0.847),
    ...
    "Water Obstruction": {
        "ranges": [(0, 2, -1.019), (2, 4, -0.817), (4, 6, -0.828), (6, 8, -0.839), (8, 10, -0.841),
